    ...
    for i, det in enumerate(pred):  # detections per image
        ...
        if len(det):
            ...
            for j in range(det.size()[0]):
                ...
                q=landmarks[2:4] 
                try:
                    wratio=fw/math.dist(p, q)
                except:
                    pass
                hratio=fw/fh

                if wratio<3 and hratio<1 and landmarks[0]>frame_thresh and landmarks[1]>frame_thresh and landmarks[2] + frame_thresh <x_max and landmarks[3]>frame_thresh and landmarks[6]>frame_thresh and landmarks[7] + frame_thresh < y_max and landmarks[8]+frame_thresh<x_max and landmarks[9]+frame_thresh<y_max:
                    boxes.append(xyxy)
                    confs.append(conf)
